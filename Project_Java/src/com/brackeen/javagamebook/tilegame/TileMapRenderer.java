...
import com.brackeen.javagamebook.tilegame.sprites.PowerUp.Bomb;
        ...
        int screenWidth, int screenHeight)
    {
        ...
        while (i.hasNext()) {
                ...
                x >= 0 && x < screenWidth) 
            {
                ...
                //start the timer for the creature to shoot..........................................and reset values
                if (sprite instanceof Grub && ((Grub) sprite).timmer == -1 ) {
                	((Grub) sprite).timmer = GameCore.cTime;
                }
                
            }
            //if not on screen Clear values for grub...................
            else if (sprite instanceof Grub && ((Grub) sprite).timmer != -1) {
                ((Grub) sprite).timmer = -1;
                ((Grub) sprite).nextt_fire = -1;
            }
        }
        //draw health
        g.setColor(Color.orange);
        g.drawString("Health: " + ((Player) player).getHealth(), 50, 66);
        
        //draw score
        //g.drawString("score: ", 520, 66);
        
      //draw bullets men list here!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

        for (Bullet tmp : GameCore.bulletlist) {
        		g.drawImage(GameCore.bulletimg, (int) tmp.getX() + offsetX +50, (int) tmp.getY() + offsetY+20, 23, 23, null);
        }
        for (Gbullet tmp : GameCore.gbulletlist) {
    		g.drawImage(GameCore.gbulletimg, (int) tmp.getX() + offsetX, (int) tmp.getY() + offsetY+10, 23, 23, null);
        }
